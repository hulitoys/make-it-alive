...
Prefer one distinctive non-human object or plant with a readable silhouette, surface identity, and structural hook. Record its frame region, approximate scale, and three nearby landmarks that make A/B correspondence obvious.

Preserve three cues:

- **Silhouette:** cup flare, leaf arc, bottle neck, stone mass, branch crown, tool head, or another dominant outline.
- **Color/material:** glaze, glass, veins, rust, bark, fiber, petals, metal, or another recognizable surface.
- **Structure:** transform one unmistakable part into anatomy, such as a handle becoming a tail, petals becoming a crest, or lamp supports becoming ears.

Turn those cues into coherent anatomy. Do not leave the literal object intact and merely add eyes or limbs.

## Creature language

Choose the body language from the source rather than making every result cute:

| Source cues | Direction |
| --- | --- |
| Round, soft, small, smooth | compact, friendly, curious |
| Thin, flexible, light, wind-shaped | nimble, alert, quick |
| Sharp, rough, heavy, angular | sturdy, defensive, confident |
| Layered, mechanical, architectural, weathered | mature guardian, calm authority |

Use a clear silhouette, expressive eyes, simplified anatomy, and a pose that suggests one visible behavior. Keep fierce or mature designs suitable for an animated companion rather than a realistic monster.
